...
python scripts/text2imgCombo_Guidance_negPrompt_TextFileInput.py --csv webDiffusion.csv --config configs/stable-diffusion/v2-inference.yaml --ckpt 512-base-ema.ckpt --fixed_code --negFile
